Create one horizontal animation strip for Codex pet `songyu`, state `running-left`.
...
State action: Continuous leftward cultivator flight loop with Song Yu clearly visible and no escape-light sphere or energy shell.

State requirements:
- Show Song Yu in a compact three-quarter side view flying toward screen-left, with her body inclined forward about 15 degrees and her face and gaze unmistakably directed left.
...
- Her long dark hair, translucent sleeves, ribbons, and skirt layers flow toward screen-right behind her in a coherent alternating wave across all 8 frames.
