Create one horizontal animation strip for Codex pet `nangong-que`, state `running-left`.
...
- Every visible shape must belong to and remain physically connected to the character silhouette. Use only clean discrete body, leg, arm, sleeve, hair, and robe poses to express motion.
- Do not draw curved swooshes, crescent arcs, ghosted robe edges, afterimages, duplicate limbs, detached cloth shapes, speed lines, dust clouds, floor shadows, motion trails, or any detached motion effect.
