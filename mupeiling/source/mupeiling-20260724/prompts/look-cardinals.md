Create one horizontal four-cardinal anchor strip for Codex pet `mupeiling`.
...
For `000`, keep the face broadly frontal and point the OPEN eyes and natural head mechanism toward the TOP edge. For `090`, put the nose tip, pupils, face surface, or natural aiming feature on the screen-right side of the head center. For `180`, keep both eyes visibly OPEN, place both pupils clearly below their eye centers, lower the chin, and point the face toward the BOTTOM edge; closed eyes are forbidden because they make the down direction ambiguous. For `270`, apply the inverse screen-left landmark rule. Every cardinal must be unmistakable without labels.
