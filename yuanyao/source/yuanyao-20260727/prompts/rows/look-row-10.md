Create one horizontal look-direction strip for Codex pet `yuanyao`, atlas row 10.
...
LEFT-HALF CONTINUITY IS A HARD GATE: frames 2 through 8 must remain on the viewer's screen-left side of the gaze loop. At frame 5 (`270`) the nose tip and both pupils point unmistakably toward the image's left edge. Frames 6-8 (`292.5`, `315`, `337.5`) must keep that same left-facing side and progressively add upward pitch; they may ease toward a near-front upward pose, but the nose and pupils must never flip to screen-right. The visible cheek, ear, braid occlusion and hair side must change gradually across `270 -> 292.5 -> 315 -> 337.5`. Reject any side-profile flip, mirrored face, sudden change of visible cheek, or reversal immediately after `270`.
